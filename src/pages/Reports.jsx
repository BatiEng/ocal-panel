...
export default function Reports() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 overflow-y-auto h-full">
      <h1 className="text-lg md:text-xl font-bold text-gray-900">Raporlar</h1>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="card p-4">
                ...
                <p className="text-xl md:text-2xl font-bold text-gray-900 mt-1">₺{fmt(data.total_revenue)}</p>
                <p className="text-xs text-gray-400 mt-1">Satış + Servis</p>
              </div>
              <div className="card p-4">
                <p className="text-xs text-gray-500">Ürün Satış Geliri</p>
                <p className="text-xl md:text-2xl font-bold text-blue-600 mt-1">₺{fmt(data.sales_revenue)}</p>
              ...
              <div className="card p-4">
                ...
                <p className="text-xl md:text-2xl font-bold text-green-600 mt-1">₺{fmt(data.service_revenue)}</p>
              ...
              <div className="card p-4">
                ...
                <p className="text-xl md:text-2xl font-bold text-purple-600 mt-1">{fmtInt(data.total_items_sold)}</p>
                <p className="text-xs text-gray-400 mt-1">Ort: ₺{fmt(data.avg_sale_value)}</p>
              </div>
            </div>
            ...
            {data.daily_breakdown?.length > 0 && (
              <div className="card p-4">
                <p className="text-sm font-semibold text-gray-700 mb-3">Günlük Gelir (Satış + Servis)</p>
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {data.service_jobs.map(j => (
                        <tr key={j.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-2 text-xs text-gray-500">{JOB_TYPE_LABEL[j.job_type] || j.job_type}</td>
