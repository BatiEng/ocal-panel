...
export default function StockLog() {
  ...
  return (
    <div className="p-6 space-y-5">
      <h1 className="text-xl font-bold text-gray-900">Stok Logu</h1>
              ...
              : movements.map(m => (
                <tr key={m.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 text-xs text-gray-500">
                    ...
                    <span className="text-gray-400">{new Date(m.created_at).toLocaleTimeString('tr-TR', {hour:'2-digit',minute:'2-digit'})}</span>
                  </td>
